...
With the Hive Post Evolution standard, advanced components are saved as stringified JSON to divs. Frontends that support this standard can parse the JSON and show the advanced component; frontends that don't, automatically show the placeholder content within `<div>` elements.
