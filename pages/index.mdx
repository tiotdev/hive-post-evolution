...
Frontends can support the option to create a copy of the post in a different language, opening this copy in a second editor. When the post is published, only the english version is saved to the post body. Other languages are saved to the languages object in the json_metadata.
